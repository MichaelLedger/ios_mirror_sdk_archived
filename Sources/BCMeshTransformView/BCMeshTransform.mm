...
{
    NSString *desc = [NSString stringWithFormat:@"Requested faceIndex (%lu) is larger or equal to number of faces (%lu)", (unsigned long)faceIndex, _faces.size()];
    NSAssert(faceIndex < _faces.size(), desc);
...
{
    NSString *desc = [NSString stringWithFormat:@"Requested vertexIndex (%lu) is larger or equal to number of vertices (%lu)", (unsigned long)vertexIndex, _vertices.size()];
    NSAssert(vertexIndex < _vertices.size(), desc);
